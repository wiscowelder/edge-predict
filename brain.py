...
def _fetch_espn_season(sport: str, year: int) -> List[dict]:
    """
    Fetches a full season from ESPN by querying 7-day date chunks.
    Uses the scoreboard endpoint with a date range parameter.
    Covers all 7 supported sports back to approximately 2002–2005.
...
def run_foundation_training(data: dict) -> dict:
    ...
    for sport in ALL_SPORTS:
        ...
        for year in range(sport_start, CURRENT_YEAR + 1):
